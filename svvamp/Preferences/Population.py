...
class Population(MyLog.MyLog):
    ...
    def __init__(self, preferences_ut=None, preferences_rk=None,
        ...
        self._condorcet_admissible_candidates_ut = None
        self._nb_condorcet_admissible_candidates_ut = None
        self._weak_condorcet_winners_ut = None
        self._nb_weak_condorcet_winners_ut = None
        ...
        self._resistant_condorcet_winner_ut_abs = None
    ...
    def preferences_borda_rk(self):
        ...
        if self._preferences_borda_rk is None:
            self._mylog("Compute preferences rankings in Borda format", 1)
    ...
    def plurality_scores_ut(self):
        ...
        voters who strictly prefer ``c`` to all other candidates (ut).
    ...
    @property
    def condorcet_admissible_candidates_ut(self):
        """1d array of booleans. ``condorcet_admissible_candidates_ut[c]`` is
        ...
        .. seealso:: :attr:`~svvamp.Population.nb_condorcet_admissible_ut`,
                     :attr:`~svvamp.Population.exists_condorcet_admissible_ut`,
                     :attr:`~svvamp.Population.not_exists_condorcet_admissible_ut`.
        """
        if self._condorcet_admissible_candidates_ut is None:
            self._mylog("Compute Condorcet-admissible candidates", 1)
            self._condorcet_admissible_candidates_ut = np.all(
                self.matrix_victories_ut_abs <= 0.5, 0)
        return self._condorcet_admissible_candidates_ut

    @property
    def nb_condorcet_admissible_ut(self):
        """Integer (number of Condorcet-admissible candidates,
        :attr:`~svvamp.Population.condorcet_admissible_candidates_ut`).
        """
        if self._nb_condorcet_admissible_candidates_ut is None:
            self._mylog("Compute number of Condorcet-admissible candidates", 1)
            self._nb_condorcet_admissible_candidates_ut = np.sum(
                self.condorcet_admissible_candidates_ut)
        return self._nb_condorcet_admissible_candidates_ut

    @property
    def exists_condorcet_admissible_ut(self):
        """Boolean (``True`` iff there is at least one Condorcet-admissible
        candidate, :attr:`~svvamp.Population.condorcet_admissible_candidates_ut`).
        """
        return self.nb_condorcet_admissible_ut > 0

    @property
    def not_exists_condorcet_admissible_ut(self):
    ...
    @property
    def weak_condorcet_winners_ut(self):
        """1d array of booleans. ``weak_condorcet_winners_ut[c]`` is ``True`` iff
        ...
        .. seealso:
            ...
            :attr:`~svvamp.Population.nb_weak_condorcet_winners_ut`,
            :attr:`~svvamp.Population.exists_weak_condorcet_winner_ut`,
            :attr:`~svvamp.Population.not_exists_weak_condorcet_winner_ut`.
        """
        if self._weak_condorcet_winners_ut is None:
            self._mylog("Compute weak Condorcet winners", 1)
            self._weak_condorcet_winners_ut = np.all(
                self.matrix_victories_ut_rel <= 0.5, 0)
        return self._weak_condorcet_winners_ut

    @property
    def nb_weak_condorcet_winners_ut(self):
        """Integer (number of weak Condorcet winners,
        :attr:`~svvamp.Population.weak_condorcet_winners_ut`).
        """
        if self._nb_weak_condorcet_winners_ut is None:
            self._mylog("Compute number of weak Condorcet winners", 1)
            self._nb_weak_condorcet_winners_ut = np.sum(
                self.weak_condorcet_winners_ut)
        return self._nb_weak_condorcet_winners_ut

    @property
    def exists_weak_condorcet_winner_ut(self):
        """Boolean (``True`` iff there is at least one weak Condorcet winner,
        :attr:`~svvamp.Population.weak_condorcet_winners_ut`).
        """
        return self.nb_weak_condorcet_winners_ut > 0

    @property
    def not_exists_weak_condorcet_winner_ut(self):
    ...
    @property
    def resistant_condorcet_winner_ut_abs(self):
        ...
        .. seealso::
            ...
            :attr:`~svvamp.Population.exists_resistant_condorcet_winner_ut_abs`,
            :attr:`~svvamp.Population.not_exists_resistant_condorcet_winner_ut_abs`.
        """
        if self._resistant_condorcet_winner_ut_abs is None:
            self._mylog("Compute Resistant Condorcet winner", 1)
            if is_resistant_condorcet(self.condorcet_winner_ut_abs,
                                      self.preferences_ut):
                self._resistant_condorcet_winner_ut_abs = self.condorcet_winner_ut_abs
            else:
                self._resistant_condorcet_winner_ut_abs = np.nan
        return self._resistant_condorcet_winner_ut_abs

    @property
    def exists_resistant_condorcet_winner_ut_abs(self):
        """Boolean (True iff there is a
        :attr:`~svvamp.Population.resistant_condorcet_winner_ut_abs`).
        """
        return not np.isnan(self.resistant_condorcet_winner_ut_abs)

    @property
    def not_exists_resistant_condorcet_winner_ut_abs(self):
        """Boolean (``True`` iff there is no
        :attr:`~svvamp.Population.resistant_condorcet_winner_ut_abs`).
        """
        return np.isnan(self.resistant_condorcet_winner_ut_abs)

    @property
    def threshold_c_prevents_w_Condorcet_ut_abs(self):
        """2d array of integers. Threshold for ``c``-manipulators to prevent
        ``w`` from being a Condorcet winner (ut_abs).
    ...
    def decreasing_borda_scores_ut(self):
        ...
        Borda score for a candidate (ut).
        """
    ...
    def demo(self, log_depth=1):
        ...
        MyLog.print_title("Condorcet notions (rk)")
        ...
        MyLog.printm("condorcet_admissible_candidates_ut = ",
              self.condorcet_admissible_candidates_ut)
        print("nb_condorcet_admissible_ut =", self.nb_condorcet_admissible_ut)
        MyLog.printm("weak_condorcet_winners_ut =", self.weak_condorcet_winners_ut)
        print("nb_weak_condorcet_winners_ut =", self.nb_weak_condorcet_winners_ut)
        print("condorcet_winner_ut_abs =", self.condorcet_winner_ut_abs)
        print("resistant_condorcet_winner_ut_abs =", self.resistant_condorcet_winner_ut_abs)
        ...
        print('Resistant Condorcet ' +
              display_bool(self.exists_resistant_condorcet_winner_ut_abs))
        print(' ||\n V')
        print('Condorcet_ut_abs ' + display_bool(self.exists_condorcet_winner_ut_abs) +
        ...
        print('Weak Condorcet ' +
              display_bool(self.exists_weak_condorcet_winner_ut))
        print(' ||')
        print(' V')
        print('Condorcet-admissible ' +
              display_bool(self.exists_condorcet_admissible_ut))
...
def is_resistant_condorcet(w, preferences_ut):
    ...
    A Condorcet winner w (in the sense of _ut_abs) is resistant iff in any
