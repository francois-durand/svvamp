...
from svvamp.Utils import MyLog, TypeChecker
from svvamp.Utils.Print import printm, print_title, print_big_title
from svvamp.Utils.Misc import compute_next_subset_with_w, compute_next_borda_clever
from svvamp.Utils.PseudoBool import pseudo_bool, neginf_to_nan, neginf_to_zero
from svvamp.Preferences.Profile import Profile
from svvamp.Preferences.ProfileSubsetCandidates import ProfileSubsetCandidates


# noinspection PySimplifyBooleanCheck
class Rule(DeleteCacheMixin, MyLog.MyLog):
    """A voting rule.
    ...
    **Implication diagram between criteria**
    ...
    def __init__(self, options_parameters=None,
        ...
        self.options_parameters = {
            'iia_subset_maximum_size': {'allowed': TypeChecker.is_number, 'default': 2},
